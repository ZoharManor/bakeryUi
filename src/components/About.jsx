      ...
      >
        ...
        <div className="order-1 lg:order-1">
          ...
          <p className="text-primary-dark/80 leading-relaxed mb-4 text-base lg:text-lg">
            לחם טנא נולדה מאהבה לבצק ולאדמה. דוד אמזל, האופה, מכין מדי בוקר לחמי
            מחמצת ולחמים מקמחי מורשת בעבודת יד טהורה. המאפייה ממוקמת בחורשה קסומה
            בקיבוץ גשר הזיו בגליל המערבי, במבנה ותיק שהפך למקום של לחם, ריחות
            ואהבה.
          </p>
